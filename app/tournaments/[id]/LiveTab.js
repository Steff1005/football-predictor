              ...
              >
                ...
                <div className="sm:hidden">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0 flex flex-col gap-1.5">
                      <span className="text-sm font-semibold text-gray-900 dark:text-white truncate">{translateTeam(match.home_team)}</span>
                      <span className="text-sm font-semibold text-gray-900 dark:text-white truncate">{translateTeam(match.away_team)}</span>
                    </div>
                ...
                <div className="hidden sm:flex items-center gap-2">
                  ...
                  <div className="flex items-center gap-1.5 w-[35%] justify-end min-w-0">
                    <span className="text-sm font-semibold text-gray-900 dark:text-white truncate text-right">{translateTeam(match.home_team)}</span>
