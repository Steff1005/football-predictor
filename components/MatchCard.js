        ...
        {isFinished ? (
          <div className="space-y-2 mb-2">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-sm text-gray-900 dark:text-white">{translateTeam(match.home_team)}</span>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-sm text-gray-900 dark:text-white">{translateTeam(match.away_team)}</span>
            </div>
          </div>
        ) : (
          <div className="mb-2">
            <div className="flex items-center gap-2">
              {match.home_logo && <img src={match.home_logo} alt="" className="w-6 h-6 object-contain flex-shrink-0" />}
              <span className="font-semibold text-sm text-gray-900 dark:text-white flex-1 min-w-0">{translateTeam(match.home_team)}</span>
              <input
            ...
            <div className="flex items-center gap-2">
              {match.away_logo && <img src={match.away_logo} alt="" className="w-6 h-6 object-contain flex-shrink-0" />}
              <span className="font-semibold text-sm text-gray-900 dark:text-white flex-1 min-w-0">{translateTeam(match.away_team)}</span>
              <input
                ref={mobileAwayRef}
      ...
      <div className="hidden sm:block">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 flex items-center justify-end gap-1.5 min-w-0">
            <span className="font-semibold text-gray-900 dark:text-white text-sm text-right truncate">{translateTeam(match.home_team)}</span>
          ...
          <div className="flex-1 flex items-center gap-1.5 min-w-0">
            ...
            <span className="font-semibold text-gray-900 dark:text-white text-sm truncate">{translateTeam(match.away_team)}</span>
          </div>
        </div>
