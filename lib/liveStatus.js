...
export function getLiveStatus(needH, needA, elapsed) {
  ...
  if (totalNeed === 1) {
    ...
    return                     { label: 'Мало часу', variant: 'warning', pulse: true,  pct: 61 }
  }
  ...
  if (totalNeed === 2) {
    ...
    return                     { label: 'Дуже складно', variant: 'danger',  pulse: true,  pct: 31 }
  }
  ...
  return                     { label: 'Майже неможливо', variant: 'near-impossible', pulse: true,  pct: 2  }
}
