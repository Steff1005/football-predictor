...
// R32 visual order: pairs that feed the same R16 match are adjacent.
//   r32-1 (1A vs 2B) + r32-7 (1B vs 2A) → r16-1  (official WC 2026 M49 + M55)
//   r32-2 (1C vs 2D) + r32-8 (1D vs 2C) → r16-2  (M50 + M56)
//   r32-3 (1E vs 2F) + r32-9 (1F vs 2E) → r16-3  (M51 + M57)
//   r32-4 (1G vs 2H) + r32-10(1H vs 2G) → r16-4  (M52 + M58)
//   r32-5 (1I vs 2J) + r32-11(1J vs 2I) → r16-5  (M53 + M59)
//   r32-6 (1K vs 2L) + r32-12(1L vs 2K) → r16-6  (M54 + M60)
//   r32-13(3T1 v 3T2)+ r32-14(3T3 v 3T4)→ r16-7  (M61 + M62)
//   r32-15(3T5 v 3T6)+ r32-16(3T7 v 3T8)→ r16-8  (M63 + M64)
export const BRACKET_ROUNDS = [
  { id: 'r32', label: '1/16', ids: [
    'r32-1','r32-7',
    'r32-2','r32-8',
    'r32-3','r32-9',
    'r32-4','r32-10',
