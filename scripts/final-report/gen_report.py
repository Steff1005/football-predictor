...
<header>
  ...
  <div class="pill">⏳ Попередня версія — попереду матч за 3-тє місце (18.07) і фінал Spain – Argentina (19.07)</div>
</header>
...
{section('maybe', 'Система 2 · чисті бали, без кф', 'Таблиця «Майже»',
  'Винагороджує близькі промахи: точний 4 · «майже» (один гол різниці) з правильним напрямком 3 · '
  '«майже» з хибним 2.5 · результат 1 · різниця голів ±1 — 0.5. Тайбрейкер — більше «майже».', t_maybe)}
...
<footer>
  ...
  Кф-таблиці поки без півфіналу England – Argentina (немає кф). Звіт буде оновлено після фіналу 19.07.
</footer>
</div>
'''
